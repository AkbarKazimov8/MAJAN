...
public class HDBSCANStarRunner {
	...
	public int[] execute(Double[][] distanceScores, ArrayList<Constraint> constraints, int minPts, int minClSize, boolean outliers) {
		...
		int numPoints = distanceScores.length;

		// Compute core distances:
		long startTime = System.currentTimeMillis();
		double[] coreDistances = HDBSCANStar.calculateCoreDistances(distanceScores, minPts);

		System.out.println("Time to compute core distances (ms): " + (System.currentTimeMillis() - startTime));

		// Calculate minimum spanning tree:
		startTime = System.currentTimeMillis();
		UndirectedGraph mst = HDBSCANStar.constructMST(distanceScores, coreDistances, true);
		...
		// IF REQUIRED, COMMENT TO PRODUCE OUTLIERS. Otherwise, no Outliers shall be produced
		if(!outliers) {
