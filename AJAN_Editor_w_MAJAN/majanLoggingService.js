...
let body = "";
let response = "<http://localhost:4202/post> <http://localhost:4202/majan-service-ns#message>  <http://localhost:4202/majan-service-ns#Received> ."
...
function sendConnectMessage(ws) {
  let wssMessage = {};
  wssMessage.body = "You are now connected to the MAJANLoggingService (majanLoggingService.js)!";
